...
<script type="application/ld+json">
{
  ...
  "name": "Anwarul Islam",
  "disambiguatingDescription": "Founder and CEO at Dekhenin.com",
  "gender": "male",
  "image": "https://anwarulislam.tk/assets/images/myphoto.jpg",
  "description": "Assalamu Alaikum Dear, Its myself Anwarul Islam. I am a web Developer and formally Graphics Designer. sometimes i write blog in online so that i am also a blogger. Here is my Html Resume.",
  "birthDate": "1998-08-24",
  "birthPlace": "Sonagazi, Feni",
  "email": "anwaarulislaam@gmail.com",
  
  "sibling": [
  	{
  		"@type": "person",
  		"name": "Abdullah Al Maruf",
        "disambiguatingDescription": "Anwarul Islam's Brother"
  	},
  	{
  		"@type": "person",
  		"name": "Jamila Sultana Nasrin",
        "disambiguatingDescription": "Anwarul Islam's Sister"
  	}
  ],
  ...
  "parent": [
  	{
  		"@type": "person",
  		"name": "Nazrul Islam",
        "disambiguatingDescription": "Anwarul Islam's Father"
  	},
  	{
  		"@type": "person",
  		"name": "Momena Khatun",
        "disambiguatingDescription": "Anwarul Islam's Mother"
  	}
  ],
  ...
  "address": {
    "@type": "PostalAddress",
    "name": "Technology Pro",
    "streetAddress": "Amligola, Azimpur",
	...
	<section id="home" class="tt-fullHeight" data-stellar-vertical-offset="50" data-stellar-background-ratio="0.2">
      ...
      <div class="social-icons">
        <ul class="list-inline">
          ...
          <li><a target="_blank"  href="https://www.youtube.com/channel/UCPVegWdHKxcNNuxv3vTPSUg"><i class="fa fa-youtube"></i></a></li>
      ...
      <div class="tf-bg-overlay">
        ...
        <div class="container">
          ...
          <div class="video-intro">
             <a class="popup-video" href="https://www.youtube.com/watch?v=GRhkd94uvWE"> <i class="fa fa-play"></i>  </a>
...
<section id="service" class="service-section section-padding">
    ...
    <section id="blog" class="latest-blog-section section-padding">
      <div class="container">
        <h2 class="section-title wow fadeInUp" style="visibility: visible; animation-name: fadeInUp;">Latest Post</h2>
